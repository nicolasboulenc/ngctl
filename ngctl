...
ngctl start [path=.] [port=%i]
	ngctl start
	ngctl start .
	ngctl start 8082
	ngctl start /home/nicolas/dev
	ngctl start /home/nicolas/dev 8088
	ngctl start . 8083
ngctl add [path] [port]
ngctl del [path]
ngctl ls
...
case "$1" in
	...
	* )
		echo "Try 'ngctl.sh help' for more information." 
	;;
